...
$(document).ready(function() {
    ...
    weather_service = $("#weather-forecast-main");
    weather_manager = $("#weather-manager-main");
   ...
   /*  $(".image-thumbnail").mouseover(function() {
      ...
      weather_service.on("click", function() {
        $("#carouselModalWeatherService").modal("show");
      });
      weather_manager.on("click", function() {
        $("#carouselModalWeatherManager").modal("show");
      });
